...
<p align="left">Meu nome é Júlia, sou cientista de dados em formação, e hoje atuo com análise de dados, automação de processos e desenvolvimento de soluções em Python, SQL e BI, além de experiência com indicadores, KPIs e dashboards gerenciais. <br><br>Além de experiência possuo conhecimento e projetos práticos na área de machine learning para análise de dados e geração de resultados.</p>

###

<p align="left">Abaixo estão as ferramentas que tenho domínio:</p>
...
<h4 align="left">Alguns projetos que fiz:</h4>
